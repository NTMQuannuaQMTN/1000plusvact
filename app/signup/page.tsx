    ...
    <div style={{
      ...
      <div className="auth-card">
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 14, marginBottom: 28 }}>
          Join thousands of students preparing with VACT
        </p>
        ...
        <p style={{ textAlign: 'center', marginTop: 24, color: 'var(--text-muted)', fontSize: 13, lineHeight: 1.6 }}>
          By signing up, you agree to VACT&#39;s Terms of Service.
        </p>
        <p style={{ textAlign: 'center', marginTop: 12, color: 'var(--text-muted)', fontSize: 14 }}>
          Already have an account?{' '}
          <a href="/login" style={{ color: 'var(--blue)', fontWeight: 600 }}>Log in</a>
        </p>
      </div>
